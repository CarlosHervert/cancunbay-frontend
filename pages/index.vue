      ...
      <client-only>
         <div class="sliderCo">
            <div v-if="$i18n.locale!=='es'">
               <img v-if="!mobile" src="/images/homeBanners/default-web-eng_1.jpg" :height="imgHeight" width="100%" />
               <img v-else src="/images/homeBanners/default-mobile-eng.jpg" :height="imgHeight" width="100%" />
            </div>
            <div v-else>
               <img v-if="!mobile" src="/images/homeBanners/default-web-esp_1.jpg" :height="imgHeight" width="100%" />
