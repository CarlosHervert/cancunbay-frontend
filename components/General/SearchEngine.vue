                           ...
                           >
                              <template #prepend>
                                 <v-icon
                                    size="22"
                                    color="#EB008B"
                                    class="icon-estrella px-1 pl-2 py-2"
                                 ></v-icon>
                              </template>
                              ...
                              <template #activator="{ on, attrs }">
                                 ...
                                 >
                                    ...
                                    <span class="d-sm-none d-block"
                                       >{{ totalPax }}
                                       {{ $t("general.people") }}</span
                                    >
                                    <v-icon
                                       size="10"
                                       color="#EB008B"
                                       class="icon-abrir-formulario ml-auto mr-5"
                                    ></v-icon>
                                 </v-btn>
                              </template>
                           ...
                           >
                              <template #prepend>
                                 <v-icon
                                    size="20"
                                    color="#EB008B"
                                    class="mr-auto ml-2 mt-2 icon-pax"
                                 >
                                 </v-icon>
                              </template>
                                 ...
                                 >
                                    <template #prepend>
                                       <v-icon
                                          size="22"
                                          color="#EB008B"
                                          class="icon-calendario px-1 pl-2 py-2"
                                       ></v-icon>
                                    </template>
                                    <template #append>
                                       <v-icon
   ...
   methods: {
      ...
      tourChange() {
         ...
         const aux = this.items.find(
            (item) => item.id === this.modelSelectTour
         );
         /*
      ...
      */
         ...
         const aux2 =
            this.modelSelectPax !== null
               ? this.paxRanges
                    .map((element) => element.id)
                    .indexOf(this.modelSelectPax)
               : false;
               ...
               .then((resp) => {
                  ...
                  if (
                     ...
                     const pos = this.items
                        ...
                        .indexOf(this.tours_state.url);

                     this.modelSelectTour =
                        pos !== false ? this.items[pos].id : "";
                     this.getDatesBlock();
      ...
      allowedDates(a) {
         ...
         if (
            ...
            if (Object.keys(this.daysBlock).length !== 0) {
               const auxiliarDias = this.daysBlock
                  .split(",")
                  .map(function (item) {
