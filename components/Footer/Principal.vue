<template>
   <div>
      <v-container class="mb-5 mt-3">
         <v-row>
            <v-col cols="12">
               <p class="colorRank font-weight-bold">
                  {{ $t("footer.we_are_in") }}
               </p>
            </v-col>
            <v-col cols="12" class="justify-content-center text-center">
               <img
                  class="mx-1 mx-md-6 my-2"
                  src="/images/layout/reserllers/getyourguide.svg"
                  :width="!mobile ? '6%' : '14%'"
                  alt="Get your guide"
               />
               <img
                  class="mx-6 mx-md-6 my-2"
                  src="/images/layout/reserllers/viator.svg"
                  :width="!mobile ? '12%' : '25%'"
                  alt="Viator"
               />
               <img
                  class="mx-1 mx-md-6 my-2"
                  src="/images/layout/reserllers/google.svg"
                  :width="!mobile ? '12%' : '25%'"
                  alt="Google"
               />
               <img
                  class="mx-1 mx-md-6 my-2"
                  src="/images/layout/reserllers/tripadvisor.svg"
                  :width="!mobile ? '15%' : '25%'"
                  alt="Trip advisor"
               />
               <img
                  class="mx-6 mx-md-6 my-2"
                  src="/images/layout/reserllers/yelp.svg"
                  :width="!mobile ? '12%' : '25%'"
                  alt="Yep"
               />
               <img
                  class="mx-1 mx-md-6 my-2"
                  src="/images/layout/reserllers/expedia.svg"
                  :width="!mobile ? '15%' : '25%'"
                  alt="Expedia"
               />
            </v-col>
         ...
         <v-row align="center">
            <v-col cols="12"
               ><h4
                  class="title-section2 text-center"
                  v-html="$t('footer.certificate')"
               ></h4
            ></v-col>
            <v-col
               cols="12"
               class="d-flex text-center align-content-center justify-center"
            >
               <img
                  class="logo logoTrip"
         ...
         <v-row align="baseline" :class="isCheckoutPage ? 'd-none' : 'd-flex'">
         ...
         <v-row :class="isCheckoutPage ? 'd-none' : 'd-flex'">
                  ...
                  <v-col sm="8" class="text-center">
                     ...
                     <div class="text-center mt-6 links">
                        <span class="d-block">
                           ...
                           >
                              {{ $t("menu.footer.terms_conditions") }}
                           </nuxt-link>
                           |
                           <nuxt-link
                              class="mx-2 menu"
                              :to="localePath({ name: 'politics' })"
                           >
                              {{ $t("menu.footer.terms_politics") }}
                           </nuxt-link>
                           |
                           <nuxt-link
                              class="mx-2 menu"
...
export default {
   ...
   methods: {
      openLink() {
         window.open(
            "https://www.tripadvisor.com/Attraction_Review-g150812-d2153780-Reviews-Cancun_Bay_Tours-Playa_del_Carmen_Yucatan_Peninsula.html",
            "_blank",
            "noreferrer"
         );
      },
